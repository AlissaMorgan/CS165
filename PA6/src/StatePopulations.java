...
public class StatePopulations{
    static class StatePair<T, S> {
        private T t;
        private S s;

        public StatePair(T intValue, S stringValue) {
            this.t = intValue;
            this.s = stringValue;
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (i = 0; i < zipCodeState.size(); ++i) {
            if(zipCodeState.get(i).equals(myZipCode)){
                System.out.println(zipCodeState.get(i).toString());
            }
         ...
         */
        StatePair studentPair = new StatePair(21044, "MD");
        studentPair.printInfo();
    }
}